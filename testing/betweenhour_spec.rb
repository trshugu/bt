...
describe BetweenHour do
  ...
  it "testException" do
    ...
    proc {@bhTest.isBetweenHour(22,-1,3)}.should raise_error(ArgumentError)
    proc {@bhTest.isBetweenHour(-23,1,3)}.should raise_error(ArgumentError)
    proc {@bhTest.isBetweenHour(22,1,-128)}.should raise_error(ArgumentError)
  end
end
